...
void Image::menu()
{
    ...
    do{
        ...
        cout<< "-------------Vous aurez le choix entre :-------------"<<endl<<"01 : Afficher votre image."<<endl<<"02 : Chercher un pixel en particulier."<<endl<<"03 : Creer un version à teinte rouge de votre image."<<endl<<"04 : Savoir si une pixel existe."<<endl<<"05 : Creer une version grise de votre image."<<endl<<"06 : Creer une version noir et blanc de votre image."<<endl;
        cout<<"07 : Conaitre l'histograme de l'image gris."<<endl<<"08 : Augmenter la luminosite de l'image."<<endl<<"09 : Dininuer la luminosite de l'image."<<endl<<"10 : Augmenter le contraste de l'image."<<endl<<"11 : Diminuer le contraste de l'image.";
        ...
        if (rep == 3){
            cout<<"Vous avez choisi de creer une version à teinte rouge de votre image"<<endl;
            (Composanterouge()).affiche();
        }
        if (rep == 4){
        ...
        if (rep == 5 ){
            cout<<"Vous avez choisi de creer une version grise de votre image"<<endl;
            (niveaugris()).affiche();
        }
        if (rep == 6){
            cout<<"Vous avez choisi de creer une version noir et blanc de votre image"<<endl;
            cout<<"entrer le seuil : ";
            int s;
            cin>>s;
            (noirEtBlanc(s)).affiche();
        }
         if (rep == 7){
            cout<<"Vous avez choisi de conaitre l'histograme de l'image gris"<<endl;
            histogrammeGris();
        }
        if (rep == 8){
            cout<<"Vous avez choisi d'augmenter la luminosité de l'image"<<endl;
            (luminosityUp()).affiche();
        }
        if (rep == 9){
            cout<<"Vous avez choisi de diminuer la luminosité de l'image"<<endl;
            (luminosityDown()).affiche();
        }
        if (rep == 10){
