...
int main() {
  ...
  try {
    ...
    vector<vector<int>> rougegreen{{000, 000, 000, 000},
                                   ...
                                   {000, 000, 000, 000},
                                   {000, 000, 000, 000}};
    Image I1(red, blue, green), IR(rougered, rougeblue, rougegreen);
  ...
  try {
    ...
    vector<vector<int>> grisgreen{{85, 85, 000, 000},
                                  ...
                                  {85, 170, 170, 85},
                                  {170, 170, 85, 85}};
    Image I1(red, blue, green), IG(grisred, grisblue, grisgreen);
    if (I1.niveaugris() == IG)
  ...
  try {
    ...
    vector<vector<int>> NBgreen{{000, 000, 000, 000},
                                ...
                                {000, 255, 255, 000},
                                {255, 255, 000, 000}};
    Image I1(red, blue, green), INB(NBred, NBblue, NBgreen);
  ...
  loadPicture(demandenom(),red,green,blue);
