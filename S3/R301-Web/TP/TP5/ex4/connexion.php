...
class Connexion {
    ...
    static private $hostname = 'localhost';   // votre serveur
    static private $database = 'nvouill';         // votre id court
    static private $login = 'nvouill';            // votre id court
    static private $password = 'ewvhGTMIjdyQ9QcP^I$E';    // votre mdp
